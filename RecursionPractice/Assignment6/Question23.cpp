/*
        ...
        ◦ Write a recursive function which counts the number of times ‘hi’ appears
            in the string. Print the value returned.
        ◦ Write a recursive function which removes all ‘hi’ in the string. Print the
            value returned.
...
int main() {
    ...
    cout << "The number of times hi appeared in " << str << " is : " << count << endl;
    string result1 = removeHi(str, 0);
    cout << str << " after removing hi is : " << result1 << endl;
    string result2 = replaceHi(str, 0);
    cout << str << " after replacing all \"hi\" with \"bye\" : " << result2 << endl;
    return 0;
}